    ...
    <div className="min-h-screen bg-paper">
      <nav className="bg-ink px-4 md:px-8 h-[52px] md:h-[60px] flex items-center justify-between sticky top-0 z-50">
        ...
        <div className="flex items-center gap-3">
          ...
          <button onClick={signOut} className="bg-white/8 border border-white/12 text-white/70 px-3 py-1 rounded-full text-xs font-syne font-semibold cursor-pointer hover:bg-white/15 hover:text-white transition-colors">Sign Out</button>
        </div>
      </nav>
